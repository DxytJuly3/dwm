...
/* appearance */
static const char *voldown[] = { "/home/july/App/dwm/diyscript/voldown.sh", NULL };
static const char *volup[] = { "/home/july/App/dwm/diyscript/volup.sh", NULL };
static const char *voltoggle[] = { "/home/july/App/dwm/diyscript/voltoggle.sh", NULL };
...
static const char *fonts[]			= {
	"Source Code Pro:size=15:type=Bold",
	"LXGW WenKai:size=15:type=Regular:antialias=true:autohint=true"
...
static const Key keys[] = {
    ...
    { MODKEY,                       XK_f,           setlayout,          {.v = &layouts[1]} },               // super + f                | 切换为 悬浮窗口布局
    { MODKEY,                       XK_m,           setlayout,          {.v = &layouts[2]} },               // super + m                | 切换为 窗口铺满布局
